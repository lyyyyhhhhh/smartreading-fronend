<template>
	<view>
		...
		<uni-nav-bar left-icon="left" @clickLeft="backLast" :border="false" height="60px" title="编辑文章集"></uni-nav-bar>
		...
		<button class="uni-btn" type="default" @click="submitupdateset"
			style="font-size: 27rpx; font-weight: bold; color:#ffffff;backgroundColor: #2979FF;borderColor:#FCC3A5; margin-left: 260rpx; margin-right: 260rpx; margin-top: 10rpx;">更新文章集</button>
						...
						success: res => {
							...
							uni.request({
								...
								success: res => {
									...
									this.articlesetFormData.setname = res.data.setname;
									this.articlesetFormData.setabstract = res.data
										.setabstract;
									...
									this.articlesetFormData.coverpic = res.data
										.coverpic;

									console.log(res.data.setarticles);
									this.articlesetres = res.data.setarticles;
